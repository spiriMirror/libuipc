...
| Engine and backend loading | `include/uipc/core/engine.h` | `src/core/core/engine.cpp`, `src/core/core/internal/engine.cpp` | `src/backends/common/module.cpp` implements query/init; `src/backends/{cuda,none}/entrance.cpp` implements create/destroy | `src/pybind/pyuipc/core/engine.cpp` | `apps/tests/core/engine.cpp` |
