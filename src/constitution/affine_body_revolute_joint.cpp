...
{
    UIPC_WARN_WITH_LOCATION(R"(AffineBodyRevoluteJoint::apply_to(SimplicialComplex&, span<SlotTuple>, Float) is deprecated. 
Ref: https://github.com/spiriMirror/libuipc/issues/259
)");
