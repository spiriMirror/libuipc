...
namespace detail
{
    ...
    static void update_ee_near_parallel_candidate(const Vector3& p,
                                                   const Vector3& s0,
                                                   const Vector3& s1,
                                                   Float&         minD,
                                                   Vector4i&      F,
                                            ...
                                            const Vector3& eb1)
    {
        ...
        {
            Float minD = 0;
            update_ee_near_parallel_candidate(ea0, eb0, eb1, minD, F,
                                             Vector4i{1, 0, 1, 1},
                                             Vector4i{1, 0, 1, 0},
                                             Vector4i{1, 0, 0, 1},
                                             true);
            update_ee_near_parallel_candidate(ea1, eb0, eb1, minD, F,
                                             Vector4i{0, 1, 1, 1},
                                             Vector4i{0, 1, 1, 0},
                                             Vector4i{0, 1, 0, 1},
                                             false);
            update_ee_near_parallel_candidate(eb0, ea0, ea1, minD, F,
                                             Vector4i{1, 1, 1, 0},
                                             Vector4i{1, 0, 1, 0},
                                             Vector4i{0, 1, 1, 0},
                                             false);
            update_ee_near_parallel_candidate(eb1, ea0, ea1, minD, F,
                                             Vector4i{1, 1, 0, 1},
                                             Vector4i{1, 0, 0, 1},
                                             Vector4i{0, 1, 0, 1},
                                             false);
