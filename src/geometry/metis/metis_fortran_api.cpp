...
// The upstream file is compiled as C. Keep the same unmangled symbol names
// when this vendored copy is compiled as C++.
extern "C" {
...
FRENAME(METIS_MeshToDual,
        (idx_t * ne, idx_t* nn, idx_t* eptr, idx_t* eind, idx_t* ncommon, idx_t* numflag, idx_t** r_xadj, idx_t** r_adjncy),
