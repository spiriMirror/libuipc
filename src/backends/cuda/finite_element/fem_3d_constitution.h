  ...
  public:
    ...
    class BaseInfo
    {
      public:
        ...
        cuda_tool::CBufferView<Matrix3x3> Dm_invs() const noexcept;
        cuda_tool::CBufferView<Float>     rest_volumes() const noexcept;
        cuda_tool::CBufferView<Vector4i>  indices() const noexcept;
