...
{
inline UIPC_GENERIC Float point_dcd_expansion(const Float& d_hat_P)
{
    return d_hat_P;
}
/**
 * @brief Edge d_hat
 */
inline UIPC_GENERIC Float edge_dcd_expansion(const Float& d_hat_E0, const Float& d_hat_E1)
{
    if constexpr(RUNTIME_CHECK)
    {
        UIPC_KERNEL_ASSERT(d_hat_E0 == d_hat_E1, "Edge d_hat should be the same");
    }
 ...
 */
inline UIPC_GENERIC Float triangle_dcd_expansion(const Float& d_hat_T0,
 ...
 */
inline UIPC_GENERIC Float PT_d_hat(const Float& d_hat_P,
 ...
 */
inline UIPC_GENERIC Float EE_d_hat(const Float& d_hat_Ea0,
 ...
 */
inline UIPC_GENERIC Float PE_d_hat(const Float& d_hat_P, const Float& d_hat_E0, const Float& d_hat_E1)
{
    if constexpr(RUNTIME_CHECK)
    {
        UIPC_KERNEL_ASSERT(d_hat_E0 == d_hat_E1, "Edge d_hat should be the same");
 ...
 */
inline UIPC_GENERIC Float PP_d_hat(const Float& d_hat_P0, const Float& d_hat_P1)
{
