...
{
    template <typename T>
    UIPC_INLINE UIPC_GENERIC Eigen::Matrix<T, 2, 2> operator()(const Eigen::Matrix<T, 2, 2>& m)
    {
    ...
    template <typename T>
    UIPC_INLINE UIPC_GENERIC Eigen::Matrix<T, 3, 3> operator()(const Eigen::Matrix<T, 3, 3>& m)
    {
    ...
    template <typename T>
    UIPC_INLINE UIPC_GENERIC Eigen::Matrix<T, 4, 4> operator()(const Eigen::Matrix<T, 4, 4>& m)
    {
  ...
  private:
    template <typename T>
    UIPC_INLINE UIPC_GENERIC void invert2x2(const T* src, T* dst)
    {
        T det;
    ...
    template <typename T>
    UIPC_INLINE UIPC_GENERIC void invert3x3(const T* src, T* dst)
    {
        T det;
    ...
    template <typename T>
    UIPC_INLINE UIPC_GENERIC void invert4x4(const T* src, T* dst)
    {
        T det;
