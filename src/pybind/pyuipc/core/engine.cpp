...
PyEngine::PyEngine(py::module& m)
{
    ...
    class_PyIEngine.def("do_advance", &PyIEngine::do_advance)
        ...
        .def("do_write_vertex_pos_to_sim", &PyIEngine::do_write_vertex_pos_to_sim, py::arg("positions"), py::arg("global_vertex_offset"), py::arg("local_vertex_offset"), py::arg("vertex_count"), py::arg("system_name"))
