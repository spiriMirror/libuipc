...
{
    auto class_SparseCOOView = py::class_<SparseCOOView>(
        m, "SparseCOOView", R"(SparseCOOView class for viewing sparse matrices in COO (Coordinate) format.)");
...
Returns:
    ...
    class_SparseCOOView.def("to_dense",
                            &SparseCOOView::to_dense,
                            R"(Convert to dense matrix representation.
Returns:
    numpy.ndarray: Dense matrix.)");

    class_SparseCOOView.def("to_sparse",
                            &SparseCOOView::to_sparse,
