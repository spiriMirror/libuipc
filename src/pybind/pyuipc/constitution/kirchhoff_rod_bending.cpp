...
PyKirchhoffRodBending::PyKirchhoffRodBending(py::module_& m)
{
    auto class_KirchhoffRodBending =
        py::class_<KirchhoffRodBending, FiniteElementExtraConstitution>(
            m, "KirchhoffRodBending", R"(KirchhoffRodBending constitution for rod bending energy.)");
...
Args:
    ...
    class_KirchhoffRodBending.def_static("default_config",
                                         &KirchhoffRodBending::default_config,
                                         R"(Get the default KirchhoffRodBending configuration.
Returns:
    dict: Default configuration dictionary.)");

    class_KirchhoffRodBending.def("apply_to",
                                  &KirchhoffRodBending::apply_to,
                                  py::arg("sc"),
                                  py::arg("E") = 10.0_MPa,
